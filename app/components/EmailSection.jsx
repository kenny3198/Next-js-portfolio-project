...
const EmailSection = () => {
  ...
  return <section  className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 realtive'>
    ...
    <div className='z-10'>
        ...
        {" "}
         ...
         <div className='socials flex flex-row gap-2'>
            ...
            <Link href='/'>
               <Image src={LinkedinIcon} alt='linkedln-image'/>
            </Link>
         </div>
    </div>
    <div>
    ...
    <div className='mb-6'>
    <label htmlFor="email" type="email" className='text-white block text-sm mb-2 font-medium'>Your Email</label>
     <input
     name='email'
      type='email'
      id='email'
       placeholder='youemail.com'
        required
        className='bg-[#18191E] border border-[33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded p-2.5 block w-full '
        />
        </div>
           <div className='mb-6'>
